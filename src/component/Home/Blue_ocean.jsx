    ...
    <div>
      ...
      <main className={`relative min-h-screen overflow-hidden ${
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
          ...
          <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 rounded-full blur-3xl opacity-10 animate-pulse ${
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <p className={`max-w-2xl mx-auto text-lg md:text-xl ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              >
                <div className="relative">
                  {/* Image Container */}
                  <div className="bg-gradient-to-br from-blue-900 to-blue-700 h-64 flex items-center justify-center overflow-hidden rounded-t-xl relative group">
                    <img
                      src={WonderplastLogo}
                      alt="Wonderplast"
                  ...
                  <div className={`p-8 text-center ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                    ...
                    <p className={`mb-6 text-base leading-relaxed ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                    ...
                    <button
                      ...
                      className={`group relative px-8 py-3 rounded-full font-semibold text-base overflow-hidden transform transition-all duration-300 hover:scale-105 active:scale-95 ${
                        isDarkMode
              ...
              >
                <div className="relative">
                  {/* Image Container */}
                  <div className="bg-gradient-to-br from-pink-300 to-pink-300 h-64 flex items-center justify-center overflow-hidden rounded-t-xl relative group">
                    <img
                  ...
                  <div className={`p-8 text-center ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                    ...
                    <h2 className={`text-3xl font-bold mb-4 ${isDarkMode ? 'text-pink-400' : 'text-pink-600'}`}>
                      Bangle Boutique
                    </h2>
